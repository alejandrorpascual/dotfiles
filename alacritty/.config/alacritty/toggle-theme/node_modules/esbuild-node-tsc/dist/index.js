...
function getBuildMetadata(userConfig) {
    ...
    const assetPatterns = ((_g = userConfig.assets) === null || _g === void 0 ? void 0 : _g.filePatterns) || ["**"];
    const assetsOptions = {
        baseDir: ((_h = userConfig.assets) === null || _h === void 0 ? void 0 : _h.baseDir) || "src",
        outDir: ((_j = userConfig.assets) === null || _j === void 0 ? void 0 : _j.outDir) || outDir,
...
function buildSourceFiles(esbuildOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield (0, esbuild_1.build)(Object.assign(Object.assign({}, esbuildOptions), { bundle: false, format: "cjs", platform: "node" }));
    });
}
